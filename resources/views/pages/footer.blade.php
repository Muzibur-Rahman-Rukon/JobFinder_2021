...
@section('tail')
            ...
            <div class="container">
                                 ...
                                 <div id="mc_embed_signup">
                                     ...
                                     method="get" class="subscribe_form relative mail_part">
                                         ...
                                         <div class="form-icon">
                                             ...
                                             class="email_icon newsletter-submit button-contactForm"><img src="{{asset('public/assets/img/icon/form.png')}}" alt=""></button>
                                         </div>
               ...
               <div class="row footer-wejed justify-content-between">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        ...
                        <a href="index.html"><img src="{{asset('public/assets/img/logo/logo2_footer.png')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
  ...
  <!-- JS here -->
        ...
        <script src="{{URL::asset('public/assets/js/price_rangs.js')}}"></script>
